...
public interface IMarketKrxEquity
{
	...
	/// <returns></returns>
	Task<ResponseResult<EquityPack>> RequestEquityInfo(string symbol, bool needsOrderBook = false, Exchange exchange = Exchange.NONE);
	...
	/// </summary>
	/// <returns></returns>
	Task<ResponseResults<SearchFilter>> RequestSearchFilters(bool forceToRefresh = false);
