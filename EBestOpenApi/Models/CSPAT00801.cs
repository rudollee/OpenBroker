...
/// 현물취소주문
/// </summary>
internal class CSPAT00801 : EBestOrderResponseStandard
{
	public OutBlock1 CSPAT00801OutBlock1 { get; set; } = new();
	public OutBlock2 CSPAT00801OutBlock2 { get; set; } = new();

	public override Int64 OrderNo { get => CSPAT00801OutBlock2.OrdNo; }
...
/// 현물취소주문 - InBlock
/// </summary>
internal class CSPAT00801InBlock1 : EBestOrderInBlockCommon
{
	/// <summary>원주문번호</summary>
	public long OrgOrdNo { get; set; }
}